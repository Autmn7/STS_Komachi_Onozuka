...
{
    public class HardworkingShinigamiPower : STS_Komachi_OnozukaPower
    {
        ...
        public override async Task BeforeHandDraw(Player player, PlayerChoiceContext choiceContext, ICombatState combatState)
        {
            ...
            int existingTokenCount = hand.Cards.Count(c => c.GetType() == typeof(ManipulateDistanceToken));
            ...
            {
                array[i] = combatState.CreateCard<ManipulateDistanceToken>(player);
            }
