...
{ 
    public class GrudgeOfTheDeadPower : STS_Komachi_OnozukaPower, IOnDetonatedListener
    {
        ...
        {
            await PowerCmd.Apply<StrengthPower>(choiceContext, target:Owner, Amount, Owner, null);
        }
    }
}
