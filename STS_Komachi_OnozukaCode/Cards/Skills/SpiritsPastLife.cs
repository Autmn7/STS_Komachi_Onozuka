...
namespace STS_Komachi_Onozuka.STS_Komachi_OnozukaCode.Cards
{
    ...
    public class SpiritsPastLife : STS_Komachi_OnozukaCard
    {
        public SpiritsPastLife() : base(1, CardType.Skill, CardRarity.Uncommon, TargetType.Self)
        {
        ...
        protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
        {
            ...
            await CardPileCmd.Draw(choiceContext, Value2, Owner);
        }
