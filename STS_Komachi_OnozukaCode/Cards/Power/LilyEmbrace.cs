...
{
    public class LilyEmbrace : STS_Komachi_OnozukaCard
    {
        public LilyEmbrace()
            : base(2, CardType.Power, CardRarity.Uncommon, TargetType.Self)
        {
            WithTip(typeof(SpiderLily));
            WithPower<StrengthPower>(nameof(Value1), 1);
            WithPower<PoisonPower>(nameof(Value2), 3, 2);
        ...
        protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
        {
            ...
            LilyEmbracePower power = await PowerCmd.Apply<LilyEmbracePower>(choiceContext, Owner.Creature,
