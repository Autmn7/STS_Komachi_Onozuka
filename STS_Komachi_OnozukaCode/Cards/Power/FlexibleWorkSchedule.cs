...
{
    public class FlexibleWorkSchedule : STS_Komachi_OnozukaCard
    {
        public FlexibleWorkSchedule()
        ...
        protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
        {
            ...
            await PowerCmd.Apply<FlexibleWorkSchedulePower>(choiceContext, Owner.Creature,
