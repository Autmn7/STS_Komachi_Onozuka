...
{
    public class HardworkingShinigami : STS_Komachi_OnozukaCard
    {
        public HardworkingShinigami()
        ...
        protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
        {
            ...
            await PowerCmd.Apply<HardworkingShinigamiPower>(choiceContext, Owner.Creature,
